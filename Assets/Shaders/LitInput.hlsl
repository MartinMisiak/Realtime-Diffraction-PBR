...
#include "Assets/Shaders/Core.hlsl"
...
half _Surface;
// Clausen BRDF
float _DiffractionWidth;
float _DiffractionHeight;
float _DiffractionPatternToggle;
// Clausen BRDF
CBUFFER_END
...
UNITY_DOTS_INSTANCING_START(MaterialPropertyMetadata)
    ...
    // Clausen BRDF
    UNITY_DOTS_INSTANCED_PROP(float , _DiffractionWidth)
    UNITY_DOTS_INSTANCED_PROP(float , _DiffractionHeight)
    UNITY_DOTS_INSTANCED_PROP(float , _DiffractionPatternToggle)
    // Clausen BRDF
...
// Clausen BRDF
#define _DiffractionWidth       UNITY_ACCESS_DOTS_INSTANCED_PROP_FROM_MACRO(float  , Metadata_DiffractionWidth)
#define _DiffractionHeight      UNITY_ACCESS_DOTS_INSTANCED_PROP_FROM_MACRO(float  , Metadata_DiffractionHeight)
#define _DiffractionHeight      UNITY_ACCESS_DOTS_INSTANCED_PROP_FROM_MACRO(float  , Metadata_DiffractionPatternToggle)
// Clausen BRDF
#endif
