Shader "CustomShaders/DiffractionLit"
{
    Properties
    {
        ...
        _AnalyticSpecularBRDFMode("Analytic Specular BRDF Mode", Float) = 1.0
    ...
    SubShader
    {
        ...
        Pass
        {
            ...
            #pragma shader_feature_local _DIRECT_LIGHT_BRDF_COOK_TORRANCE
    ...
    CustomEditor "UnityEditor.Rendering.Universal.ShaderGUI.DiffractionLitShader"
}
