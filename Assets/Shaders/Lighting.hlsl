    ...
    half clearCoatMask, bool specularHighlightsOff)
{
    ...
    {  
#if defined _DIRECT_LIGHT_BRDF_COOK_TORRANCE
        brdf += DirectBRDFSpecular_GGXReference(brdfData, normalWS, lightDirectionWS, viewDirectionWS);
#elif defined _DIRECT_LIGHT_BRDF_DIFFRACTION
        brdf += DirectBRDFSpecular_Diffraction(brdfData, normalWS, lightDirectionWS, viewDirectionWS);
#else
...
half4 UniversalFragmentPBR(InputData inputData, SurfaceData surfaceData)
{
    ...
    brdfData.uvs        = inputData.uvs;
    brdfData.wsPosition = inputData.positionWS;
    #endif
    // Clausen BRDF
